...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, crop_size, hazy_refer_flist, hazy_flist, clean_flist=None, augment=True, split='pair'):

        self.clean_data = self.load_flist(clean_flist)   # list
        self.noisy_data = self.load_flist(hazy_flist)   # list
        self.noisy_data_refer = self.load_flist(hazy_refer_flist)
