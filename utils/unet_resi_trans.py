...
if __name__ == '__main__':
    UResnet34 = UResnet_trans(block=BasicBlock, layers=[3, 4, 6, 3], num_classes=2)  
    print(UResnet34)
    x=torch.rand((1,3,256,256))
    t1= UResnet34.forward(x)
    UResnet50 = UResnet_trans(block=BottleNeck, layers=[3, 4, 6, 3], num_classes=2)

    UReset101 = UResnet_trans(block=BottleNeck, layers=[3, 4, 23, 3], num_classes=2)

    UReset152 = UResnet_trans(block=BottleNeck, layers=[3, 8, 36, 3], num_classes=2)
